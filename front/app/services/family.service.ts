...
export class FamilyService {
    ...
    getMembersUrl = "http://localhost:8080/family/members/getNames/";
    ...
    getAllMembersUrl = "http://localhost:8080/family/members/getAll/";
    ...
    getAllMembers(familyId : string): Observable<Response> {
